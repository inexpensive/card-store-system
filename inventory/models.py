...
class MagicCard(models.Model):
    ...
    ordered_card_names = ArrayField(models.CharField(max_length=170), null=True)
    is_focal_card = models.BooleanField(default=True)
    super_types = ArrayField(models.CharField(max_length=40), null=True)
    super_types_text = models.CharField(max_length=100, blank=True)
    types = ArrayField(models.CharField(max_length=40), null=True)
    types_text = models.CharField(max_length=100, blank=True)
    sub_types = ArrayField(models.CharField(max_length=40), null=True)
    sub_types_text = models.CharField(max_length=100, blank=True)
    mana_cost = models.CharField(max_length=100, default='')
    ...
    image = models.ImageField(upload_to='inventory/static/images/', default='images/None/no_art.jpg', max_length=300)
